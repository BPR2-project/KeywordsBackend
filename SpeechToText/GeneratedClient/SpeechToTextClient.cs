...
namespace speechToText_api
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.0.0.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AzureSpeechToTextClient : IAzureSpeechToTextClient
    {
        private string _baseUrl;
        private static System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings, true);

        public AzureSpeechToTextClient(string baseUrl)
        {
            BaseUrl = baseUrl;
        }
        ...
        public virtual async System.Threading.Tasks.Task<PronunciationAssessmentResponse> CreatePronunciationAssessmentAsync(string language, string ocp_Apim_Subscription_Key, string pronunciation_Assessment, System.IO.Stream body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    urlBuilder_.Append("speech");
                    urlBuilder_.Append('/');
                    urlBuilder_.Append("recognition");
                    urlBuilder_.Append('/');
                    urlBuilder_.Append("conversation");
                    urlBuilder_.Append('/');
                    urlBuilder_.Append("cognitiveservices");
                    urlBuilder_.Append('/');
            ...
            urlBuilder_.Length--;
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PronunciationAssessmentResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
