...
namespace indexer_api
{
    ...
    public partial interface IIndexerClient
    {
        ...
        /// <returns>Returns list of account info</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<AccountInfo>> GetTokenAsync(string ocp_Apim_Subscription_Key, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <returns>Returns indexer output</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<VideoIndexerResponse> GetIndexerOutputAsync(string location, string accountId, string videoId, string accessToken, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class IndexerClient : IIndexerClient
    {
        ...
        /// <returns>Returns list of account info</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<AccountInfo>> GetTokenAsync(string ocp_Apim_Subscription_Key, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/auth/trial/Accounts?generateAccessTokens=true&allowEdit=true");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<AccountInfo>>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>Returns indexer output</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<VideoIndexerResponse> GetIndexerOutputAsync(string location, string accountId, string videoId, string accessToken, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (location == null)
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/{location}/Accounts/{accountId}/Videos/{videoId}/Index?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<VideoIndexerResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual async System.Threading.Tasks.Task<IndexVideoReceipt> IndexVideoAsync(string location, string accountId, string accessToken, string name, string videoUrl, string privacy = null, string language = null, string sourceLanguages = null, System.Collections.Generic.IEnumerable<string> excludedAI = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/{location}/Accounts/{accountId}/Videos?");
            urlBuilder_.Replace("{location}", System.Uri.EscapeDataString(ConvertToString(location, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{accountId}", System.Uri.EscapeDataString(ConvertToString(accountId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Append(System.Uri.EscapeDataString("accessToken") + "=").Append(System.Uri.EscapeDataString(ConvertToString(accessToken, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<IndexVideoReceipt>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 409)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<IndexInProgress>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                            throw new ApiException<IndexInProgress>("Video already in process", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AccountInfoArray : System.Collections.ObjectModel.Collection<AccountInfo>
    {
